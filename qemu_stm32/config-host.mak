...
extra_cflags=-m64 -DSTM32_UART_ENABLE_OVERRUN
extra_ldflags=
qemu_localedir=${prefix}/share/locale
libs_softmmu=-lutil -lncurses -ltinfo  -luuid -lpng16 -lz  -L$(BUILD_DIR)/dtc/libfdt -lfdt -lpixman-1
ARCH=x86_64
CONFIG_DEBUG_TCG=y
CONFIG_POSIX=y
CONFIG_LINUX=y
...
VERSION=2.1.3
PKGVERSION=
SRC_PATH=/home/ubuntu/Workspace/Beckus/qemu_stm32
...
CFLAGS_NOPIE=
QEMU_CFLAGS=-fPIE -DPIE -m64 -D_GNU_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Wstrict-prototypes -Wredundant-decls -Wall -Wundef -Wwrite-strings -Wmissing-prototypes -fno-strict-aliasing -fno-common -DSTM32_UART_ENABLE_OVERRUN -DSTM32_UART_NO_BAUD_DELAY -DDEBUG_STM32_UART -DDEBUG_STM32_RCC -DDEBUG_CLKTREE  -Wendif-labels -Wmissing-include-dirs -Wempty-body -Wnested-externs -Wformat-security -Wformat-y2k -Winit-self -Wignored-qualifiers -Wold-style-declaration -Wold-style-definition -Wtype-limits -fstack-protector-strong -I/usr/include/libpng16 -I/usr/include/pixman-1 -I$(SRC_PATH)/dtc/libfdt
QEMU_INCLUDES=-I$(SRC_PATH)/tcg -I$(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/home/ubuntu/Workspace/Beckus/qemu_stm32/linux-headers -I. -I$(SRC_PATH) -I$(SRC_PATH)/include
AUTOCONF_HOST := 
